...
<html lang="en">
 <head>
  <title>Emily Brune: Contact Form</title>
 ...
 <body>
     <header>
     <h1>Emily Brune: Contact Form</h1>
     <nav class="topnav" id="myTopnav">
       ...
       <a href="contact.php" class="active">Contact Emily</a>
	...
	?>
     ...
     <footer>
      <p><small>&copy; 2022 by 
          <a href="contact.php">Emily Brune</a>, All Rights Reserved ~ 
